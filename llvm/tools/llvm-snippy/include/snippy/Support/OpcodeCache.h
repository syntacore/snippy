...
#ifndef LLVM_TOOLS_LLVM_SNIPPY_SUPPORT_OPCODECACHE_H
#define LLVM_TOOLS_LLVM_SNIPPY_SUPPORT_OPCODECACHE_H
...
#endif // LLVM_TOOLS_LLVM_SNIPPY_SUPPORT_OPCODECACHE_H
