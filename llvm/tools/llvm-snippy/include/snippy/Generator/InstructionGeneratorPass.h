...
//
//===----------------------------------------------------------------------===//
#ifndef LLVM_TOOLS_LLVM_SNIPPY_GENERATOR_INSTRUCTIONGENERATORPASS_H
#define LLVM_TOOLS_LLVM_SNIPPY_GENERATOR_INSTRUCTIONGENERATORPASS_H
...
#endif // LLVM_TOOLS_LLVM_SNIPPY_GENERATOR_INSTRUCTIONGENERATORPASS_H
